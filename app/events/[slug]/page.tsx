...
const EventDetailsPage = async ({params}:{params:Promise<{slug: string}>})=> {
    ...
    const {description,audience,image,overview,date,time,location,mode,agenda,organizer,tags} = event;
  ...
  return (
    <section id="event">
        ...
        <div className="details">
            ...
            <section className="fexl-col-gap-2">
                <h2>Overview</h2>
                <p>{overview}</p>
            </section>
            ...
            <section>
                ...
                <EventDeatilItem icon="../icons/pin.svg" alt="pin" label={location}/>
